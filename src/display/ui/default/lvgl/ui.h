...
LV_IMG_DECLARE(ui_img_steam_knob_anim); // [steam-anim] "turn the steam knob" hint GIF
LV_IMG_DECLARE(ui_img_brew_pour_anim);  // [brew-anim] animated coffee-pour start button GIF
LV_IMG_DECLARE(ui_img_water_pour_anim); // [water-anim] animated hot-water button GIF
